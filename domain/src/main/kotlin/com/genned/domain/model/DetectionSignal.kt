...
/**
 * One piece of evidence from one [com.genned.domain.provider.DetectionProvider].
 *
 ...
 *   (`[0, 1]`), independent of the score. Used by [com.genned.domain.evidence.EvidenceEngine]
